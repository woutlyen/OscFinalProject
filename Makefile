...
test: main.c connmgr.c sbuffer.c connmgr.h sbuffer.h lib/tcpsock.c sensor_db.c sensor_db.h
	gcc -g main.c sbuffer.c connmgr.c sensor_db.c lib/tcpsock.c -o main.out -lpthread